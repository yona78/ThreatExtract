...
- Vote toward final decision (08): SecureBERT for the product task, with the strongest caveat so far: a substantial share of the lead is structural advantage from ontology/training lineage and should not be overclaimed as general NER superiority.
